const { getMultiBuoyGeoJsonData, getBuoysCoordinates, getBuoyIds, getBuoyVariables, getSummaryData } = require('@/clients/erddap');
...
const queryErddapBuoys = (payload, rawNumPoints) => {
